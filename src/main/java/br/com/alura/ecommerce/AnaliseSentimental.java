...
public class AnaliseSentimental {

    public static void main(String[] args) throws InterruptedException {
        var arquivosDeAvaliacoes = carregarArquivosAv();
        ...
        for (var arquivo : arquivosDeAvaliacoes) {
            ...
            salvarArquivoAnalise(arquivo, resposta);
    ...
    private static String enviarRequisicao(Path arquivo) throws InterruptedException {
        ...
        var promptSistema = """
                ...
                """;
        var promptUsuario = lerArquivo(arquivo);
...
private static List<Path> carregarArquivosAv() {
    try {
...
private static String lerArquivo(Path arquivo) {
    try {
        ...
        throw new RuntimeException("Erro ao ler conteúdo do arquivo!", e);
    }
}

private static void salvarArquivoAnalise(Path arquivo, String analise) {
    try {
